...
func TestValidLength(t *testing.T) {
	...
	for i, testCase := range testCases {
		t.Run(fmt.Sprintf("testCase[%d] %s", i+1, testCase.name), func(t *testing.T) {
			assert.Equal(t, testCase.expected, validate.ValidLength(testCase.password))
		})
	}
}
...
func TestValidLetter(t *testing.T) {
	...
	for i, testCase := range testCases {
		t.Run(fmt.Sprintf("testCase[%d] %s", i+1, testCase.name), func(t *testing.T) {
			assert.Equal(t, testCase.expected, validate.ValidLetter(testCase.password))
		})
	}
}
...
func TestIsWeakPassword(t *testing.T) {
	...
	for i, testCase := range testCases {
		t.Run(fmt.Sprintf("testCase[%d] %s", i+1, testCase.name), func(t *testing.T) {
			assert.Equal(t, testCase.expected, validate.IsWeakPassword(testCase.password, testCase.path))
		})
	}
}
...
func TestLoadWeakPasswordList(t *testing.T) {
	...
	assert.IsType(t, make(map[string]bool), weakList)
}
